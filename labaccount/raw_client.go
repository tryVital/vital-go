...
func (r *RawClient) GetTeamLabAccounts(
	ctx context.Context,
	request *vitalgo.LabAccountGetTeamLabAccountsRequest,
	opts ...option.RequestOption,
) (*core.Response[*vitalgo.GetTeamLabAccountsResponse], error) {
	...
	var response *vitalgo.GetTeamLabAccountsResponse
	...
	return &core.Response[*vitalgo.GetTeamLabAccountsResponse]{
