...
func TestBodyGetWithWireMock(
	...
	_, invocationErr := client.Body.Get(
		context.TODO(),
		"user_id",
		request,
	)
	...
	VerifyRequestCount(t, "GET", "/v2/summary/body/user_id", map[string]string{"start_date": "start_date"}, 1)
}

func TestBodyGetRawWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Body.GetRaw(
		context.TODO(),
		"user_id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/v2/summary/body/user_id/raw", map[string]string{"start_date": "start_date"}, 1)
}
