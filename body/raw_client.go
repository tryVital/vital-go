...
func (r *RawClient) Get(
...
) (*core.Response[*vital.ClientBodyResponse], error) {
	...
	var response *vital.ClientBodyResponse
	...
	return &core.Response[*vital.ClientBodyResponse]{
...
func (r *RawClient) GetRaw(
	...
	opts ...option.RequestOption,
) (*core.Response[*vital.RawBody], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*vital.RawBody]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
