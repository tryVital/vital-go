...
var (
	...
	labTestsGetMarkersRequestFieldLabSlug         = big.NewInt(1 << 1)
	labTestsGetMarkersRequestFieldName            = big.NewInt(1 << 2)
	labTestsGetMarkersRequestFieldALaCarteEnabled = big.NewInt(1 << 3)
	labTestsGetMarkersRequestFieldLabAccountId    = big.NewInt(1 << 4)
	labTestsGetMarkersRequestFieldPage            = big.NewInt(1 << 5)
	labTestsGetMarkersRequestFieldSize            = big.NewInt(1 << 6)
)
...
// SetLabSlug sets the LabSlug field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (l *LabTestsGetMarkersRequest) SetLabSlug(labSlug *string) {
	l.LabSlug = labSlug
	l.require(labTestsGetMarkersRequestFieldLabSlug)
}
