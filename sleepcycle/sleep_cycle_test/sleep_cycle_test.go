...
func TestSleepCycleGetWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.SleepCycle.Get(
		context.TODO(),
		"user_id",
		request,
	)
	...
	VerifyRequestCount(t, "GET", "/v2/summary/sleep_cycle/user_id", map[string]string{"start_date": "2023-01-15"}, 1)
}
