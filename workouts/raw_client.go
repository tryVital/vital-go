...
func (r *RawClient) Get(
...
) (*core.Response[*vital.ClientWorkoutResponse], error) {
	...
	var response *vital.ClientWorkoutResponse
	...
	return &core.Response[*vital.ClientWorkoutResponse]{
...
func (r *RawClient) GetRaw(
	...
	opts ...option.RequestOption,
) (*core.Response[*vital.RawWorkout], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*vital.RawWorkout]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
...
func (r *RawClient) GetByWorkoutId(
	...
	workoutId string,
	opts ...option.RequestOption,
) (*core.Response[*vital.ClientFacingStream], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	var response *vital.ClientFacingStream
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*vital.ClientFacingStream]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
