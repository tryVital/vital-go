...
func TestProfileGetWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Profile.Get(
		context.TODO(),
		"user_id",
		request,
	)
	...
	VerifyRequestCount(t, "GET", "/v2/summary/profile/user_id", nil, 1)
}

func TestProfileGetRawWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Profile.GetRaw(
		context.TODO(),
		"user_id",
		request,
	)
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/v2/summary/profile/user_id/raw", nil, 1)
}
