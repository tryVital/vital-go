...
func (r *RawClient) Search(
...
) (*core.Response[*vitalgo.SearchCompendiumResponse], error) {
	...
	var response *vitalgo.SearchCompendiumResponse
	...
	return &core.Response[*vitalgo.SearchCompendiumResponse]{
...
func (r *RawClient) Convert(
	...
	opts ...option.RequestOption,
) (*core.Response[*vitalgo.ConvertCompendiumResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	headers.Add("Content-Type", "application/json")
	var response *vitalgo.ConvertCompendiumResponse
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*vitalgo.ConvertCompendiumResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
