...
package electrocardiogram_test
...
func TestElectrocardiogramGetWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Electrocardiogram.Get(
		context.TODO(),
		"user_id",
		request,
	)
	...
	VerifyRequestCount(t, "GET", "/v2/summary/electrocardiogram/user_id", map[string]string{"start_date": "2023-01-15"}, 1)
}
