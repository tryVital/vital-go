...
func (r *RequestOptions) ToHeader() http.Header {
	...
	if r.ApiKey != "" {
		header.Set("x-vital-api-key", fmt.Sprintf("%v", r.ApiKey))
	}
	return header
}
...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/tryVital/vital-go/v505")
	headers.Set("X-Fern-SDK-Version", "v1.1.576")
	headers.Set("User-Agent", "github.com/tryVital/vital-go/v1.1.576")
	return headers
}
