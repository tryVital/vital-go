...
func (r *RawClient) ResendEvents(
...
) (*core.Response[*vital.ResendWebhookResponse], error) {
	...
	endpointURL := baseURL + "/v3/order/resend_events"
	...
	var response *vital.ResendWebhookResponse
	...
	return &core.Response[*vital.ResendWebhookResponse]{
