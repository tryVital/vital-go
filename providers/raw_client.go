...
func (r *RawClient) GetAll(
...
) (*core.Response[[]*vital.ClientFacingProviderDetailed], error) {
	...
	var response []*vital.ClientFacingProviderDetailed
	...
	return &core.Response[[]*vital.ClientFacingProviderDetailed]{
