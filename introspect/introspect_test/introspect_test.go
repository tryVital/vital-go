...
func TestIntrospectGetUserResourcesWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Introspect.GetUserResources(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/v2/introspect/resources", nil, 1)
}

func TestIntrospectGetUserHistoricalPullsWithWireMock(
	t *testing.T,
) {
	ResetWireMockRequests(t)
	WireMockBaseURL := "http://localhost:8080"
	...
	_, invocationErr := client.Introspect.GetUserHistoricalPulls(
		context.TODO(),
		request,
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/v2/introspect/historical_pull", nil, 1)
}
