...
func (r *RawClient) GetTransaction(
...
) (*core.Response[*v505.GetOrderTransactionResponse], error) {
	...
	var response *v505.GetOrderTransactionResponse
	...
	return &core.Response[*v505.GetOrderTransactionResponse]{
